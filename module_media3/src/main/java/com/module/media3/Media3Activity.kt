...
import com.module.media3.databinding.ActivityMedia3Binding
import java.util.Formatter
import java.util.Locale

@UnstableApi
class Media3Activity : AppCompatActivity(), View.OnClickListener {

    private lateinit var mDataBinding: ActivityMedia3Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mDataBinding = DataBindingUtil.setContentView(this, R.layout.activity_media3)
