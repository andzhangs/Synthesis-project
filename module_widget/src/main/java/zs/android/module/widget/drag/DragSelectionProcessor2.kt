 ...
 * @mark 自定义类描述
 */
class DragSelectionProcessor2 constructor(private val mSelectionHandler: DragSelectionProcessor2.ISelectionHandler?=null): DragSelectTouchListener2.OnAdvancedDragSelectListener {
    ...
    var mStartFinishedListener: DragSelectionProcessor2.ISelectionStartFinishedListener? = null
     ...
     * @return this
     */
    fun withMode(mode: Mode?): DragSelectionProcessor2 {
        mMode = mode
        return this
    }
     ...
     * @return this
     */
    fun withStartFinishedListener(startFinishedListener: DragSelectionProcessor2.ISelectionStartFinishedListener?): DragSelectionProcessor2 {
     ...
     * @return this
     */
    fun withCheckSelectionState(check: Boolean): DragSelectionProcessor2 {
    ...
    interface ISelectionHandler {
        ...
        /**
         * only used, if [DragSelectionProcessor2.withCheckSelectionState] was enabled
         ...
         * @param calledFromOnStart true, if it was called from the [DragSelectionProcessor2.onSelectionStarted] event
         */
