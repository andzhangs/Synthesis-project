 ...
 * @mark 自定义类描述
 */
class DragSelectionProcessor constructor(private val mSelectionHandler: DragSelectionProcessor.ISelectionHandler?=null): DragSelectTouchListener.OnAdvancedDragSelectListener {
    ...
    var mStartFinishedListener: DragSelectionProcessor.ISelectionStartFinishedListener? = null
     ...
     * @return this
     */
    fun withStartFinishedListener(startFinishedListener: DragSelectionProcessor.ISelectionStartFinishedListener?): DragSelectionProcessor {
